 ...
 */
export const update5 = <ThrowOnError extends boolean = false>(options: Options<Update5Data, ThrowOnError>): RequestResult<unknown, Update5Errors, ThrowOnError> => (options.client ?? client).put<unknown, Update5Errors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/admin/program-editions/{editionId}/document-requirements/{requirementId}',
    ...options,
    headers: {
 ...
 */
export const get1 = <ThrowOnError extends boolean = false>(options: Options<Get1Data, ThrowOnError>): RequestResult<unknown, Get1Errors, ThrowOnError> => (options.client ?? client).get<unknown, Get1Errors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const list4 = <ThrowOnError extends boolean = false>(options: Options<List4Data, ThrowOnError>): RequestResult<unknown, List4Errors, ThrowOnError> => (options.client ?? client).get<unknown, List4Errors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
