 ...
 */
export const options = <ThrowOnError extends boolean = false>(options?: Options<OptionsData, ThrowOnError>): RequestResult<OptionsResponses, OptionsErrors, ThrowOnError> => (options?.client ?? client).get<OptionsResponses, OptionsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const options1 = <ThrowOnError extends boolean = false>(options: Options<Options1Data, ThrowOnError>): RequestResult<Options1Responses, Options1Errors, ThrowOnError> => (options.client ?? client).get<Options1Responses, Options1Errors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
