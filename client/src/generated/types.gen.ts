...
export type AdminApplicationListResponse = {
    content?: Array<AdminApplicationResponse>;
    page?: number;
    size?: number;
    totalElements?: number;
    totalPages?: number;
...
export type AdminApplicationResponse = {
    ...
    applicant?: ApplicationUserSummaryResponse;
    registeredBy?: ApplicationUserSummaryResponse;
    assignedWorker?: ApplicationUserSummaryResponse;
 ...
 */
export type ApplicationUserSummaryResponse = {
    id?: number;
    username?: string;
    name?: string;
    email?: string;
...
export type ListManagedApplicationsData = {
    body?: never;
    path?: never;
    query?: {
        page?: number;
...
export type ListManagedApplicationsErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type ListManagedApplicationsError = ListManagedApplicationsErrors[keyof ListManagedApplicationsErrors];

export type ListManagedApplicationsResponses = {
    /**
     * OK
     */
...
export type ListManagedApplicationsResponse = ListManagedApplicationsResponses[keyof ListManagedApplicationsResponses];
...
export type GetManagedApplicationData = {
    body?: never;
    path: {
        id: string;
    };
...
export type GetManagedApplicationErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type GetManagedApplicationError = GetManagedApplicationErrors[keyof GetManagedApplicationErrors];
