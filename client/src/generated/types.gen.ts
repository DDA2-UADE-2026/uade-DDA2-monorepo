 ...
 */
export type ProgramImageResponse = {
    /**
     * UUID de la imagen.
     */
    readonly id?: string;
    /**
     * UUID del programa asociado.
     */
    ...
    /**
     * Tipo MIME validado de la imagen.
     */
 ...
 */
export type CreateCenterOpeningHoursRequest = {
    days?: Array<'MONDAY' | 'TUESDAY' | 'WEDNESDAY' | 'THURSDAY' | 'FRIDAY' | 'SATURDAY' | 'SUNDAY'>;
    startTime?: string;
    endTime?: string;
};
...
export type AdminApplicationListItemResponse = {
    ...
    userId?: number;
    /**
     * Nombre del titular registrado en users, no en una identidad externa.
     */
    userName?: string;
    userEmail?: string;
    /**
     * ID interno de quien registró la solicitud. En una presentación propia coincide con userId.
     */
    registeredByUserId?: number;
    programId?: string;
    programName?: string;
    ...
    status?: 'DRAFT' | 'SUBMITTED' | 'IN_VALIDATION' | 'PENDING_DOCUMENTATION' | 'IN_EVALUATION' | 'IN_VISIT' | 'APPROVED' | 'REJECTED' | 'WAITLISTED' | 'CLOSED';
    /**
     * Trabajador asignado a la solicitud. Todavía no se asigna desde ninguna operación.
     */
...
export type AdminApplicationListResponse = {
    content?: Array<AdminApplicationListItemResponse>;
    /**
     * Número de página, comenzando en cero.
     */
    page?: number;
...
export type AdminApplicationResponse = {
    ...
    status?: 'DRAFT' | 'SUBMITTED' | 'IN_VALIDATION' | 'PENDING_DOCUMENTATION' | 'IN_EVALUATION' | 'IN_VISIT' | 'APPROVED' | 'REJECTED' | 'WAITLISTED' | 'CLOSED';
    /**
     * Identificador del trámite de origen, cuando la solicitud llegó desde otro canal.
     */
    originTicketId?: string;
    /**
     * Motivo de la resolución. Todavía no se completa desde ninguna operación.
     */
    ...
    updatedAt?: string;
    /**
     * Clave de idempotencia con la que se presentó la solicitud, solo visible en esta vista administrativa.
     */
    idempotencyKey?: string;
    /**
     * Hash del cuerpo asociado a la clave de idempotencia. Existe si y solo si existe la clave.
     */
    requestHash?: string;
    /**
     * Documentos obligatorios todavía faltantes u observados. Una entrega PENDING ya presentada no aparece aquí.
...
export type DeleteProgramImageData = {
    body?: never;
    path: {
        /**
         * UUID del programa.
...
export type DeleteProgramImageErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type DeleteProgramImageError = DeleteProgramImageErrors[keyof DeleteProgramImageErrors];

export type DeleteProgramImageResponses = {
    /**
     * Imagen eliminada.
     */
    204: void;
...
export type DeleteProgramImageResponse = DeleteProgramImageResponses[keyof DeleteProgramImageResponses];

export type CreateProgramImageData = {
    body?: {
        file: Blob | File;
    };
    path: {
...
export type CreateProgramImageErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type CreateProgramImageError = CreateProgramImageErrors[keyof CreateProgramImageErrors];

export type CreateProgramImageResponses = {
    /**
     * Imagen creada.
     */
    201: ProgramImageResponse;
};

export type CreateProgramImageResponse = CreateProgramImageResponses[keyof CreateProgramImageResponses];

export type UpdateProgramImageData = {
    body?: {
        file: Blob | File;
    };
    path: {
...
export type UpdateProgramImageErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type UpdateProgramImageError = UpdateProgramImageErrors[keyof UpdateProgramImageErrors];

export type UpdateProgramImageResponses = {
    /**
     * Imagen reemplazada.
     */
    200: ProgramImageResponse;
};

export type UpdateProgramImageResponse = UpdateProgramImageResponses[keyof UpdateProgramImageResponses];
...
export type Put1Error = Put1Errors[keyof Put1Errors];
...
export type Put1Response = Put1Responses[keyof Put1Responses];
...
export type CreateCenterOpeningHoursBatchData = {
    body: CreateCenterOpeningHoursRequest;
    path: {
        centerId: string;
    };
    query?: never;
...
export type CreateCenterOpeningHoursBatchErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type CreateCenterOpeningHoursBatchError = CreateCenterOpeningHoursBatchErrors[keyof CreateCenterOpeningHoursBatchErrors];

export type CreateCenterOpeningHoursBatchResponses = {
    /**
     * Created
     */
    201: Array<CenterOpeningHourResponse>;
};

export type CreateCenterOpeningHoursBatchResponse = CreateCenterOpeningHoursBatchResponses[keyof CreateCenterOpeningHoursBatchResponses];
...
export type List4Responses = {
     ...
     */
    200: AdminApplicationListResponse;
};
...
export type GetPublicImageErrors = {
    /**
     * La solicitud es inválida.
     */
    400: ErrorResponse;
...
export type GetPublicImageError = GetPublicImageErrors[keyof GetPublicImageErrors];

export type GetPublicImageResponses = {
    /**
