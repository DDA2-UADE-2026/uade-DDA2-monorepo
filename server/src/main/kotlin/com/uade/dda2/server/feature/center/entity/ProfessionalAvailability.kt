...
@Table(
    ...
    indexes = [
        Index(
            name = "ix_professional_availability_assignment_day_active",
            columnList = "assignment_id, day_of_week, active",
        ),
    ],
    check = [
        CheckConstraint(
            name = "ck_professional_availability_time_range",
...
class ProfessionalAvailability(
    ...
    var assignment: ProfessionalAssignment,
