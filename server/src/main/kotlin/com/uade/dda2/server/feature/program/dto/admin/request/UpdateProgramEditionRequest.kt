...
@Schema(description = "Datos requeridos para actualizar una edición de un programa.")
data class UpdateProgramEditionRequest(

    @field:Schema(description = "Nombre actualizado de la edición.", example = "Convocatoria 2026 ampliada")
    ...
    @field:Schema(description = "Fecha de finalización de la edición.", example = "2026-12-15", format = "date")
    val endDate: LocalDate,

    @field:Schema(description = "Cantidad máxima de participantes admitidos.", example = "300", minimum = "1")
