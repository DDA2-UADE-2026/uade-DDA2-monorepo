        ...
        OpenAPI()
            .info(
                Info()
                    ...
                    .description(
                        "API REST para administrar autenticación, usuarios, roles, permisos, programas sociales, actividades comunitarias, períodos de inscripción y solicitudes propias y asistidas.",
                    )
                    .version("1.0.0")
